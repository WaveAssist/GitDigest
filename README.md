...
- **Required**
  ...
  - **GitHub Integration**: Connect your GitHub account and select repositories to monitor. GitDigest will automatically access:
...
GitDigest delivers a **single comprehensive Ground Truth email**—business + technical in one—plus a PDF for sharing. Every claim is backed by the actual code diff.
...
GitDigest runs on a **weekly schedule** (default: every Monday at 8:30 AM UTC, configurable). Each report covers the previous 7 days of activity across all tracked repositories.

---

## How It Works

GitDigest follows a CID pipeline (Collection, Intelligence, Delivery) anchored on diffs:
