...
print("GitDigest: Starting email generation...")
...
def generate_pdf_attachment(html_content: str, project_name: str) -> tuple[Optional[io.BytesIO], str, Optional[str]]:
    ...
    """
    pdf_filename = f"GitDigest_Report_{project_name.replace(' ', '_')}_{datetime.now().strftime('%Y%m%d_%H%M')}.pdf"
    pdf_file = None
...
def build_combined_email(
    ...
    <body>
        <div class="container">
            ...
            <div class="footer">
                <p>Generated by <a href="https://gitzoid.com" style="color: #1ED66C; text-decoration: none;">GitDigest</a> · Powered by <a href="https://waveassist.io" style="color: #1ED66C; text-decoration: none;">WaveAssist</a></p>
...
try:
    ...
    <body>
        <div class="container">
            ...
            {date_range_text}
            <p class="footer">Generated by <a href="https://gitzoid.com" style="color: #1ED66C; text-decoration: none;">GitDigest</a></p>
        </div>
    </body>
    </html>
        """

        subject = f"GitDigest: {project_name} - No Activity This Week"
        ...
        print("GitDigest: No activity email sent." if email_sent else "GitDigest: No activity email send failed.")
        ...
        if not business_report_valid or not technical_report_valid:
            ...
            waveassist.store_data("display_output", display_output, run_based=True, data_type="json")
            print(f"GitDigest: Report validation failed - {error_msg}. Email not sent.")
        else:
            ...
            print("GitDigest: Sending email with PDF attachment...")
            email_sent = waveassist.send_email(
    ...
    waveassist.store_data("display_output", display_output, run_based=True, data_type="json")
    print(f"GitDigest: Email build failed: {e}. Email not sent.")

print("GitDigest: Email generation completed.")
